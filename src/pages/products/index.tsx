...
function ProductListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<ProductInterface[]>(
    ...
    () =>
      getProducts({
        relations: ['marketplace', 'auction.count', 'purchase.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('purchase', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>purchase</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
